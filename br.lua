-- FINAL COLOSSAL TEST - Working
print("===== COLOSSAL TEST =====")

task.wait(1) -- Character load hone do
...
if titansFolder then
    for _, titan in ipairs(titansFolder:GetChildren()) do
        ...
        local nape = titan:FindFirstChild("Hitboxes") and titan:FindFirstChild("Hitboxes"):FindFirstChild("Hit") and titan:FindFirstChild("Hitboxes").Hit:FindFirstChild("Nape")
        if nape then
