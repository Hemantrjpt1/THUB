...
function AutoFarm:Start()
	...
	task.spawn(function()
		...
		while self._running do
			...
			local local _co = workspace:FindFirstChild("Titans") and workspace.Titans:FindFirstChild("Colossal_Titan")
				colossalTitan = _co and (_co:FindFirstChild("Colossal_Titan") or _co) or workspace:FindFirstChild("Colossal_Titan")
			...
			-- ==========================================
			if isColossalRaid then
				local _co = workspace:FindFirstChild("Titans") and workspace.Titans:FindFirstChild("Colossal_Titan")
				colossalTitan = _co and (_co:FindFirstChild("Colossal_Titan") or _co) or workspace:FindFirstChild("Colossal_Titan")
								...
								for _, wall in ipairs(walls:GetChildren()) do
									...
									if cannons then
										for _, c in ipairs(cannons:GetChildren()) do
											if c:IsA("Model") then
												cannon = c
												barrelWood = c:FindFirstChild("Barrel") and c.Barrel:FindFirstChild("BarrelWood")
												base = c:FindFirstChild("Base")
												break
											end
										end
									end
